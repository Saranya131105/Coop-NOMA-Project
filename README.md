...
## ⚙️ Requirements
Install Python libraries before running the notebook:
...
jupyter notebook
        ...
        -->Open Coop_NOMA.ipynb.

Run all cells to:

       -->Generate outage probability results.

       -->Save results into CSV files.

       -->Save plots into the plots/ folder.
